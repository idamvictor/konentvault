...
export const settingsSidebar = [
  ...
  },
  {
    ...
    route: "/creator/settings/security",
    icon: Lock,
  },
  {
    label: "Subscription Settings",
    route: "/creator/settings/subscription",
    icon: Settings,
  },
  {
    label: "Banking (To Earn)",
    route: "/creator/settings/banking",
    icon: ShieldCheck,
  },
  {
    label: "Two-Factor Authentication",
    route: "/creator/settings/two-factor",
    icon: KeyRound,
  },
  {
    label: "ID Verification",
    route: "/creator/settings/id-verification",
    icon: KeyRound,
  },
];
